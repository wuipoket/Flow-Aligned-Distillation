...
PASS1_LOG_EVERY=50 \
PASS1_VAL_EVERY="${FAD_PASS1_VAL_EVERY:-500}" \
PASS1_VAL_MAX_RECORDS="${FAD_PASS1_VAL_MAX_RECORDS:-2048}" \
...
RESUME_TRAINING_CHECKPOINT="${FAD_RESUME_TRAINING_CHECKPOINT:-}" \
RESUME_DATA_STEP="${FAD_RESUME_DATA_STEP:-0}" \
PASS1_LATEST_CHECKPOINT_EVERY="${FAD_PASS1_LATEST_CHECKPOINT_EVERY:-0}" \
PASS1_LATEST_CHECKPOINT_INCLUDE_OPTIMIZER="${FAD_PASS1_LATEST_CHECKPOINT_INCLUDE_OPTIMIZER:-False}" \
